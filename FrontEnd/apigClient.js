...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://z7xnekbzrd.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.donatePost = function (params, body, additionalParams) {
        ...
        var donatePostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/donate').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(donatePostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.donateOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var donateOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/donate').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(donateOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.donatePhotosKeyPost = function (params, body, additionalParams) {
        ...
        var donatePhotosKeyPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/donate/photos/{key}').expand(apiGateway.core.utils.parseParametersToObject(params, ['key'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(donatePhotosKeyPostRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.removePost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['body'], ['body']);
        
        var removePostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/remove').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(removePostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.requestPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['body'], ['body']);
        
        var requestPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/request').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(requestPostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.requestOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var requestOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/request').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(requestOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        var searchGetRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['body']),
            body: body
        };
